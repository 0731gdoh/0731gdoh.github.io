...
var EFFECT = Effect.createList(
  ...
  ,["攻撃力減少/Reduce Outgoing Damage", "こうけけ", 0, 0.01, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ...
  ,["熱情時強化/Ardor Strengthening", "ねつ", 1, 0.01, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF|EFFECT_FLAG.GIMMICK]
  ...
  ,["<暗闇>時強化[シヴァ]/Darkness Strengthening[Shiva]", "くら", 0, 2.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ...
  ,["打撃と斬撃と横一文字への大特防/Big Blow%%Slash%%Long-Slash damage reduction", "たけきとさ", 1, 0.1, WEAPON_FLAG.BLOW|WEAPON_FLAG.SLASH|WEAPON_FLAG.LONGSLASH, EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE, TYPE.WEAPON_WEAKNESS]
  ,["射撃と狙撃への大特防/Big Shot%%Snipe damage reduction", "しやけきと", 1, 0.1, WEAPON_FLAG.SHOT|WEAPON_FLAG.SNIPE, EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE, TYPE.WEAPON_WEAKNESS]
  ...
  ,["全域大特防/Big All damage reduction", "せんいきた", 1, 0.1, WEAPON_FLAG.ALL, EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE, TYPE.WEAPON_WEAKNESS]
  ...
  ,["全域特防[ビッグフット]/All damage reduction[Bigfoot]", "せんいきと", 1, 0.8, WEAPON_FLAG.ALL, EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE, TYPE.WEAPON_WEAKNESS]
  ...
  ,["特防[0.65]/Bonus[0.65]", "とくほ", 1, 0.65, , EFFECT_FLAG.FIXED|EFFECT_FLAG.STACKABLE, TYPE.BONUS]
  ...
  ,["全域特防[零の例外処理]/All damage reduction[Null Exception]", "せんいきと", 1, 0.1, WEAPON_FLAG.ALL, EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.GIMMICK, TYPE.WEAPON_WEAKNESS]
  ...
  ,["打撃特防/Blow damage reduction", "たけきとく", 1, 0.5, WEAPON_FLAG.BLOW, EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE, TYPE.WEAPON_WEAKNESS]
