...
var EFFECT = Effect.createList(
  ...
  ,[43, "武器種弱点[1.7]/Weapon Weakness[1.7]", "ふき", 1, 1.7, , EFFECT_FLAG.FIXED|EFFECT_FLAG.STACKABLE|EFFECT_FLAG.GIMMICK, TYPE.BONUS]
  ,[44, "武器種弱点[10.0]/Weapon Weakness[10.0]", "ふき", 1, 10, , EFFECT_FLAG.FIXED|EFFECT_FLAG.STACKABLE|EFFECT_FLAG.GIMMICK, TYPE.BONUS]
  ...
  ,[88, "剣豪フランクフルト/Swordmaster's Hot Dog", "", 0, 1, , EFFECT_FLAG.EVENT|EFFECT_FLAG.FIXED, TYPE.ATK]
  ...
  ,[107, "<暴走+>時強化[スノウ]/Berserk+ Strengthening[Snow]", "ほうそ+", 0, 2.6, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[108, "<*暴走+>時強化[スノウ]/Berserk+ Strengthening[Snow]", "ほうそしき+", 1, 0.77, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ...
  ,[112, "<*暴走>時防御強化/DEF Up when Berserk", "ほうそしほ", 1, 0.7, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[113, "<*暴走+>時防御強化/DEF Up when Berserk+", "ほうそしほ+", 1, 0.7, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ...
  ,[119, "本格コルク銃/Classic Popgun", "", 0, 1, , EFFECT_FLAG.EVENT|EFFECT_FLAG.FIXED, TYPE.ATK]
  ...
  ,[162, "非<祈り>時強化/Non-Prayer Strengthening", "ひい", 0, [1, 4], , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.NON_STATUS]
  ...
  ,[167, "<*劫火>時強化[クトゥグァ#1]/Conflagration Strengthening[Cthugha]", "こうか", 1, 0.35, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ...
  ,[174, "<滋養>時強化[アシガラ]/Nourishment Strengthening[Ashigara]", "しようしき", 0, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[175, "滋養時強化[アシガラ]/Nourishment Strengthening[Ashigara]", "しようしき", 1, 0.6, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ...
  ,[182, "武器種弱点[2.0]/Weapon Weakness[2.0]", "ふき", 1, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.STACKABLE, TYPE.BONUS]
  ...
  ,[207, "武器種弱点[1.3]/Weapon Weakness[1.3]", "ふき", 1, 1.3, , EFFECT_FLAG.FIXED|EFFECT_FLAG.STACKABLE, TYPE.BONUS]
  ...
  ,[221, "<*発狂>時弱化[ニャルラトテプ☆4]/Madness Weakening[Nyarlathotep ☆4]", "はつ", 1, 3, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ...
  ,[280, "威圧時弱化[ギリメカラ]/Oppression Weakening[Girimekra]", "いあつしし", 0, 0.75, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ...
  ,[298, "劫火時強化[クトゥグァ#2]/Conflagration Strengthening[Cthugha]", "こうかし", 0, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ...
  ,[301, "<*火傷>大特攻[アフラ・マズダ]/Big Advantage vs Burn[Ahura Mazda]", "やけとた", 0, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.STACKABLE|EFFECT_FLAG.IRREMOVABLE]
  ...
  ,[343, "<滋養>時強化[冥境AR]/Nourishment Strengthening[冥境AR]", "しようしき", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ...
  ,[351, "祝福時強化[マサシ]/Blessing Strengthening[Masashi]", "しゆくふくしき", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ...
  ,[363, "奮起時弱化[ペルーン]/Arousal Weakening[Perun]", "ふん", 1, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ...
  ,[370, "魅了大特攻[テュアリング]/Big Advantage vs Charm[Tuaring]", "みりようた", 0, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BONUS_TO_DEBUFF]
  ,[371, "威圧時弱化[タイシャクテン]/Oppression Weakening[Taishakuten]", "いあつしし", 0, 0.4, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ...
  ,[396, "魅了時弱化[バティム]/Charm Weakening[Bathym]", "みりようしし", 1, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ,[397, "マヒ大特攻/Big Advantage vs Paralysis", "まひた", 0, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BONUS_TO_DEBUFF]
  ,[398, "<*烙印>特攻[ハクメン]/Advantage vs Stigma[Hakumen]", "らく", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[399, "注目時強化[サトルヌス]/Taunt Strengthening[Saturnus]", "ちゆ", 0, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[400, "照準/Sharpshooter", "しようしゆ", 1, 1.5, , EFFECT_FLAG.IRREMOVABLE]
  ,[401, "閃き時強化[トムテ]/Glint Strengthening[Tomte]", "ひらめきしき", 0, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[402, "祈り時強化[エーコー]/Prayer Strengthening[Echo]", "いの", 1, 0.1, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[403, "祈り/Prayer", "いの", 0, 1, , EFFECT_FLAG.FIXED|EFFECT_FLAG.TOKEN]
  ,[404, "武器種弱点[2.5]/Weapon Weakness[2.5]", "ふき", 1, 2.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.STACKABLE, TYPE.BONUS]
  ,[405, "加速時強化[ガルム#1]/Acceleration Strengthening[Garmr]", "かそ", 0, 4, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[406, "<*加速>時強化[ガルム#2]/Acceleration Strengthening[Garmr]", "かそ", 1, 0.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[407, "発狂時強化[ニャルラトテプ]/Madness Strengthening[Nyarlathotep]", "はつきようしき", 0, 8, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ,[408, "発狂時弱化[限定ニャルラトテプ]/Madness Weakening[Limited Nyarlathotep]", "はつきようしし", 0, 0.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ,[409, "<*火傷>特攻[ミカイール=ファヴニル]/Advantage vs Burn[Michael]", "やけとと", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.STACKABLE|EFFECT_FLAG.IRREMOVABLE]
  ,[410, "注目時強化[サンゾウ]/Taunt Strengthening[Sanzo]", "ちゆうもくしき", 1, 0.75, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[411, "不動時強化[ハーロット#2]/Immobility Strengthening[Babalon]", "ふと", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[412, "<火傷>時強化[プロメテウス]/Burn Strengthening[Prometheus]", "やけとし", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ...
  ,[422, "<滋養>時弱化[リョウタ]/Nourishment Weakening[Ryota]", "しようしし", 0, 0.6, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[423, "<熱情>時強化[ノブハル]/Ardor Strengthening[Nobuharu]", "ねつ", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[424, "集中時強化[ジャンバヴァン]/Concentration Strengthening[Jambavan]", "しゆう", 1, 0.7, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[425, "弱体無効時強化[イクトシ]/Nullify Debuff Strengthening[Ikutoshi]", "しやくたいむ", 1, 0.7, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[426, "威圧特攻[イクトシ=ギリメカラ]/Advantage vs Oppression[Ikutoshi]", "いあつと", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BONUS_TO_DEBUFF]
  ,[427, "<*烙印>時弱化/Stigma Weakening", "らくいんしし", 1, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[428, "<*凍結>時防御弱化/Freeze Weakened Defense", "とうけつしほ", 1, 0, 10000, EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[429, "加速時強化[ゴウリョウ]/Acceleration Strengthening[Ganglie]", "かそ", 0, 6, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[430, "虚飾時弱化/Flamboyance Weakening", "きよしよくしし", 1, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ...
  ,[437, "威圧時強化/Oppression Strengthening", "いあつしき", 0, 8, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ,[438, "<マヒ>時強化/Paralysis Strengthening", "まひし", 0, 8, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[439, "恐怖時強化/Fear Strengthening", "きようふし", 0, 8, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ,[440, "不動時強化[ガーゴイル]/Immobility Strengthening[Gargoyle]", "ふと", 0, 8, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ...
  ,[458, "閃き時強化[ユーマ：味方全体]/Glint Strengthening[Yuma: all allies]", "ひらめきしき", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ...
  ,[464, "発狂時強化[アイギパーン]/Madness Strengthening[Aegipan]", "はつきようしき", 0, 5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.DEBUFF]
  ,[465, "<熱情>時強化[シパクトリ]/Ardor Strengthening[Cipactli]", "ねつ", 0, 2, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE]
  ,[466, "閃き時弱化/Glint Weakening", "ひらめきしし", 0, 0.7, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
  ,[467, "魅了特攻/Advantage vs Charm", "みりようと", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BONUS_TO_DEBUFF]
  ,[468, "奮起時強化[クランプス=AR]/Arousal Strengthening[Krampus]", "ふん", 0, 1.5, , EFFECT_FLAG.FIXED|EFFECT_FLAG.IRREMOVABLE|EFFECT_FLAG.BUFF]
