...
var AR = Record.createList(
  ...
  ,["仕事終わりのひとときを/A Special Moment After Work/しごとおわりのひとときを", 134, "獲得コインアップ/友情時強化", "", "", "", "", 4, 100, EQUIP.ANY, 0, 0, "", "", ""]
  ...
  ,["虎たちの乾杯/虎たちの乾杯/とらたちのかんぱい", 122, "CP増加/威圧特攻[AR]/特攻[1.4]", "威圧特攻[AR]", "", "", "", 4, 200, 0, 0, EQUIP.THRUST|EQUIP.MAGIC, "ノーマッド/ドゥルガー/リチョウ", "", ""]
  ...
  ,["ひとりだけのあなたへ/For You and Only You", 135, "花獲得率アップ", "弱体解除(単)", "", "", "", 4, 200, EQUIP.ANY, 0, 0, "", "", ""]
  ,["光輝成す刃たち/光輝成す刃たち/こうきなすやいばたち", 136, "極限/ARトークン獲得率アップ", "", "", "", "", 5, 500, 0, EQUIP.ALLROUND, EQUIP.SLASH, "", "サモナーズ", ""]
