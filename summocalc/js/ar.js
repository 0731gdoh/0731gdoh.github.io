...
var AR = Record.createList(
  ...
  ,[4, "長途の待人の破片/長途の待人の破片/ちょうとのまちびとのはへん", false, ["告死x", "", ""], 2, 0, 0, EQUIP.WOOD, 0, "", "", "", "@フィッシャーキング"]
  ,[5, "重来の武将の破片/重来の武将の破片/ちょうらいのぶしょうのはへん", false, ["憑依x", "", ""], 2, 125, 0, EQUIP.WATER, 0, "", "", "", "@ユキムラ"]
  ...
  ,[129, "N番目の祝宴/N番目の祝宴/Nばんめのしゅくえん", true, ["狙撃に特防[0.8]/j祝福", "", ""], 3, 0, 0, 0, EQUIP.LONGSLASH|EQUIP.THRUST|EQUIP.SLASH, "@ヤスヨリ/オンブレティグレ", "", "", ""]
  ,[130, "母と子と/母と子と/ははとこと", true, ["花獲得率アップ", "udHP回復", ""], 5, 100, 0, EQUIP.FIRE|EQUIP.NETHER, 0, "", "ジェノサイダーズ", "", "@アルク/@ハーロット"]
  ,[131, "夏の日の一枚/夏の日の一枚/なつのひのいちまい", true, ["魅了x/t意気", "", ""], 3, 150, 0, EQUIP.ALLROUND|EQUIP.WATER|EQUIP.INFERNAL, 0, "@ベイブ・バニヤン/シュクユウ", "", "", ""]
  ,[132, "ある安らぎの日/ある安らぎの日/あるやすらぎのひ", true, ["獲得コインアップ/獲得ランク経験値アップ", "", ""], 5, 400, EQUIP.RARE1|EQUIP.RARE2, EQUIP.FIRE|EQUIP.WATER, 0, "", "タイクーンズ", "", "@リヒト"]
  ,[133, "シークレット・エージェンツ/シークレット・エージェンツ/しーくれっと・えーじぇんつ", true, ["崩しx", "", "pm恐怖"], 3, 300, 0, 0, EQUIP.SHOT|EQUIP.SLASH|EQUIP.MAGIC, "", "エージェンツ", "", "@オセ"]
  ...
  ,[143, "聖夜の彩り/聖夜の彩り/せいやのいろどり", true, ["凍結x/jCP増加", "", ""], 3, 100, 0, 0, EQUIP.SHOT|EQUIP.SNIPE, "シトリー/@アギョウ/チェルノボーグ", "", "", ""]
  ...
  ,[148, "干支っ子たちの正月始め！/干支っ子たちの正月始め！/えとっこたちのしょうがつはじめ！", true, ["魔法に特防[0.8]/pd閃き", "", ""], 3, 50, 0, 0, EQUIP.SHOT|EQUIP.MAGIC, "アギョウ/@イナバ", "", "", ""]
  ...
  ,[1136, "ウェルカムトゥサイバースペース/ウェルカムトゥサイバースペース/うぇるかむとぅさいばーすぺーす", false, ["p弱体無効/全域に特防[0.6]", "p弱体無効", ""], 5, 250, 0, 0, EQUIP.SLASH|EQUIP.MAGIC|EQUIP.NONE, "@ティンダロス/エニグマ", "", "", ""]
  ...
  ,[1139, "炎天下のレッスルウォー/炎天下のレッスルウォー/えんてんかのれっするうぉー", false, ["打撃に特防[0.8]", "", "tHP減少"], 3, 300, 0, 0, EQUIP.BLOW|EQUIP.THRUST|EQUIP.LONGSLASH, "アヴァルガ/@ジュウゴ", "", "", ""]
  ...
  ,[1148, "家族の事が知りたくて/家族の事が知りたくて/かぞくのことがしりたくて", false, ["マヒx/j閃き時強化[AR]", "", ""], 4, 250, 0, 0, EQUIP.THRUST|EQUIP.MAGIC, "クロガネ/@ヘパイストス", "", "", ""]
  ...
  ,[1152, "スノー&シュガー/スノー&シュガー/すのー&しゅがー", true, ["p凍結耐性/jHP減少反転/idHP回復", "p凍結耐性", ""], 4, 100, 0, EQUIP.AETHER|EQUIP.NETHER, 0, "ジェド/ネクロス&バッカス", "", "", "@バッカス"]
  ...
  ,[1154, "辺獄の子らに愛を/辺獄の子らに愛を/へんごくのこらにあいを", false, ["打撃に特防[0.8]", "", "pm脱力"], 3, 100, 0, 0, EQUIP.SLASH|EQUIP.MAGIC, "@ジズ/ハーロット", "", "", ""]
  ...
  ,[1163, "赤と白の格子暗号/赤と白の格子暗号/あかとしろのこうしあんごう", false, ["baスキル封印耐性", "", "pa確率強化解除/id強化解除(単)"], 4, 200, 0, 0, EQUIP.SHOT|EQUIP.SNIPE, "テュアリング/@ウランバートル", "", "", ""]
