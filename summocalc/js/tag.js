...
var TAG = Tag.createList(
  ...
  ,["回避時強化", "かいひしき", TAG_TYPE.IRREMOVABLE_BUFF, "発動率増加系"]
  ...
  ,["大筒の支配者/大筒の支配者(Ruler of Munition)", "おお", TAG_TYPE.SKILL]
  ...
  ,["大雪山に篭る者/大雪山に篭る者(Mt.Daisetsu Dweller)", "たいせ", TAG_TYPE.SKILL]
  ...
  ,["不死身の密林王/Immortal King of Thorns", "ふしみの", TAG_TYPE.SKILL]
  ...
  ,["HPが減少する弱体", "HPけん", TAG_TYPE.STATUS_GROUP, "", "告死/凍結/毒/猛毒/火傷/烙印"]
  ...
  ,["無垢なる獣/無垢なる獣(Pure Beast)", "むく", TAG_TYPE.SKILL]
  ...
  ,["強化を再付与", "きようかをさ", TAG_TYPE.ONE_SHOT]
  ,["弱体を再付与", "しやくたいをさ", TAG_TYPE.ONE_SHOT]
  ...
  ,["横移動力減少", "よこけん1", TAG_TYPE.IRREMOVABLE_DEBUFF, "移動力減少系"]
  ,["横移動力大減少", "よこけん2", TAG_TYPE.IRREMOVABLE_DEBUFF, "移動力減少系"]
  ...
  ,["全域大特防", "せんいた", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ...
  ,["縦移動力増加", "たてそう", TAG_TYPE.BUFF, "移動力増加系"]
  ,["意気時強化", "いきしき", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ,["対ダメージ攻撃強化付与", "たいためこう", TAG_TYPE.IRREMOVABLE_BUFF]
  ,["退場時HP激減", "たいしよHP", TAG_TYPE.IRREMOVABLE_BUFF]
  ,["退場時CP激減", "たいしよCP", TAG_TYPE.IRREMOVABLE_BUFF]
  ...
  ,["連撃時強化", "れんしき", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ,["暗闇時弱化", "くらしし", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,["暗闇時弱化[エリイ]", "", TAG_TYPE.IRREMOVABLE_DEBUFF, "暗闇時弱化/HP減少系"]
  ,["ターン開始時憑依", "たあひよ", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,["攻撃後HP吸収", "こうけきこHPき", TAG_TYPE.IRREMOVABLE_BUFF]
  ...
  ,["崩し特攻", "くすしと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "崩し"]
  ,["全域特防", "せんいと", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ,["HPが継続回復する状態/Healing status", "HPけい", TAG_TYPE.STATUS_GROUP, "", "再生/祝福/滋養/聖油"]
  ,["凍結時弱化", "とうけしし", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,["祝福時強化", "しゆくしき", TAG_TYPE.IRREMOVABLE_BUFF]
  ...
  ,["威圧特攻", "いあと", TAG_TYPE.IRREMOVABLE_BUFF]
