...
Tag.createList = function(a){
  ...
  a.forEach(function(v, i){
    ...
    if(match && v[2] !== TAG_TYPE.CATEGORY){
      if(match[2]) c.push(tget((match[1] || "") + "○○時" + (match[3] ? "弱化" : "強化")));
...
var TAG = Tag.createList(
  ...
  ,[68, "係留/Anchor", "けいり", TAG_TYPE.BUFF, "強制移動無効系"]
  ...
  ,[74, "劫火時強化#1/Conflagration Strengthening", "こうかしき 1", TAG_TYPE.IRREMOVABLE_BUFF, "劫火時強化/防御増加系/CP増加系"]
  ,[75, "攻撃強化/ATK Up", "こうけきき", TAG_TYPE.BUFF, "攻撃増加系"]
  ,[76, "攻撃力減少/Reduced ATK", "こうけきりよくけん", TAG_TYPE.IRREMOVABLE_DEBUFF, "攻撃減少系"]
  ...
  ,[86, "根性/Guts", "こんし", TAG_TYPE.BUFF, "復活系"]
  ...
  ,[123, "注目/Taunt", "ちゆ", TAG_TYPE.BUFF, "ヘイト操作系", "", "", "注目[解除不可]"]
  ...
  ,[166, "憑依/Possession", "ひよ", TAG_TYPE.DEBUFF, "攻撃不可系"]
  ...
  ,[192, "暴走時強化[オズ]/Berserk Strengthening[Oz]", "ほうそしき お", TAG_TYPE.IRREMOVABLE_BUFF, "暴走時強化/発動率増加系"]
  ,[193, "暴走+時強化[スノウ]/Berserk+ Strengthening[Snow]", "ほうそしき+ す", TAG_TYPE.IRREMOVABLE_BUFF, "暴走+時強化/攻撃増加系/防御増加系"]
  ...
  ,[196, "魅了/Charm", "みり", TAG_TYPE.DEBUFF, "攻撃不可系"]
  ...
  ,[275, "発動率増加系/Probability Increase", "はつ1", TAG_TYPE.CATEGORY]
  ,[276, "発動率減少系/Probability Decrease", "はつ2", TAG_TYPE.CATEGORY]
  ...
  ,[298, "滋養時弱化[サンダユウ]/Nourishment Weakening[Sandayu]", "しようしし さ", TAG_TYPE.IRREMOVABLE_DEBUFF, "滋養時弱化/発動率減少系"]
  ...
  ,[339, "継続回復強化/Continuous HP recovery boosted", "けいそくか", TAG_TYPE.IRREMOVABLE_BUFF, "効果増強系"]
  ,[340, "継続ダメージ強化/Increase Continuous Damage", "けいそくた", TAG_TYPE.IRREMOVABLE_DEBUFF, "効果増強系"]
  ...
  ,[355, "注目[解除不可]/Taunt[cannot be removed]", "", TAG_TYPE.IRREMOVABLE_BUFF, "注目/ヘイト操作系"]
  ...
  ,[381, "HP減少反転/HP Decrease Reversal", "HPけはん", TAG_TYPE.BUFF, "増減反転系"]
  ,[382, "HP回復反転/HP Recovery Reversal", "HPかはん", TAG_TYPE.DEBUFF, "増減反転系"]
  ,[383, "ダメージ反転/Damage Reversal", "ためはん", TAG_TYPE.BUFF, "防御増加系/増減反転系"]
  ...
  ,[421, "混乱/Confusion", "こんら", TAG_TYPE.DEBUFF, "[攻撃後]/移動力減少系"]
  ...
  ,[440, "弱体無効時強化[ウランバートル☆3]/Nullify Debuff Strengthening[Ulaanbaatar ☆3]", "しやくたいむしき う3", TAG_TYPE.IRREMOVABLE_BUFF, "弱体無効時強化/攻撃増加系"]
  ,[441, "弱体無効時強化[ウランバートル☆5]/Nullify Debuff Strengthening[Ulaanbaatar ☆5]", "しやくたいむしき う5", TAG_TYPE.IRREMOVABLE_BUFF, "弱体無効時強化/攻撃増加系"]
  ...
  ,[463, "対ダメージ攻撃強化付与/Counter: ATK Up", "たいためこう", TAG_TYPE.IRREMOVABLE_BUFF, "[対ダメージ]"]
  ...
  ,[501, "友時強化[イナバ]/Friendship Strengthening[Inaba]", "ゆうしき い", TAG_TYPE.IRREMOVABLE_BUFF, "友時強化/HP回復系"]
  ...
  ,[513, "魔法弱点/Shot Weakness", "まほし", TAG_TYPE.IRREMOVABLE_DEBUFF, "武器種弱点系/防御減少系", , [TAG_FLAG_NUM.BONUS_D, "", "武器種弱点[2.5]"]]
  ...
  ,[545, "劫火時強化#2/Conflagration Strengthening", "こうかしき 2", TAG_TYPE.IRREMOVABLE_BUFF, "劫火時強化/攻撃増加系"]
  ...
  ,[685, "注目時弱化[クランプス]/Taunt Weakening[Krampus]", "ちゆしし く", TAG_TYPE.IRREMOVABLE_DEBUFF, "注目時弱化/防御減少系"]
  ...
  ,[728, "暴走+時強化[ハクメン]/Berserk+ Strengthening[Hakumen]", "ほうそしき+ は", TAG_TYPE.IRREMOVABLE_BUFF, "暴走+時強化/CP増加系"]
  ...
  ,[736, "対ダメージCP増加", "たいためCP", TAG_TYPE.IRREMOVABLE_BUFF, "[対ダメージ]"]
  ...
  ,[769, "不動時強化[ハーロット#1]/Immobility Strengthening[Babalon]", "ふとしき は1", TAG_TYPE.IRREMOVABLE_BUFF, "不動時強化/CP増加系"]
  ,[770, "不動時強化[ハーロット#2]/Immobility Strengthening[Babalon]", "ふとしき は2", TAG_TYPE.IRREMOVABLE_BUFF, "不動時強化/攻撃増加系"]
  ,[771, "火傷時強化[プロメテウス]/Burn Strengthening[Prometheus]", "やけしき ふ", TAG_TYPE.IRREMOVABLE_BUFF, "火傷時強化/攻撃増加系/防御増加系"]
  ,[772, "祝福時強化[ベルフェゴール]/Blessing Strengthening[Belphegor]", "しゆくしき へ", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/CP増加系"]
  ,[773, "友時強化/Friendship Strengthening", "ゆうしき", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[774, "友時強化[ベルフェゴール]/Friendship Strengthening[Belphegor]", "ゆうしき へ", TAG_TYPE.IRREMOVABLE_BUFF, "友時強化/CP増加系"]
  ,[775, "暴走時強化/Berserk Strengthening", "ほうそしき", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[776, "暴走時強化[アメノウズメ]/Berserk Strengthening[Ame-no-Uzume]", "ほうそしき あ", TAG_TYPE.IRREMOVABLE_BUFF, "暴走時強化/防御増加系"]
  ,[777, "暴走+時強化[アメノウズメ]/Berserk+ Strengthening[Ame-no-Uzume]", "ほうそしき+ あ", TAG_TYPE.IRREMOVABLE_BUFF, "暴走+時強化/防御増加系"]
  ,[778, "ターン開始時HP回復/Restore HP at Turn Start", "たあHPか", TAG_TYPE.IRREMOVABLE_BUFF, "[ターン開始時]"]
  ,[779, "攻撃力増加[チョウジ]", "", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃力増加/攻撃増加系"]
  ...
  ,[782, "加速時強化[ウィリー]/Acceleration Strengthening[Willie]", "かそしき う", TAG_TYPE.IRREMOVABLE_BUFF, "加速時強化/攻撃増加系"]
  ...
  ,[786, "加速時強化[グンゾウ]/Acceleration Strengthening[Gunzo]", "かそしき く", TAG_TYPE.IRREMOVABLE_BUFF, "加速時強化/攻撃増加系"]
  ...
  ,[790, "恐怖時弱化[ニャルラトテプ]/Fear Weakening[Nyarlathotep]", "きようふしし に", TAG_TYPE.IRREMOVABLE_DEBUFF, "恐怖時弱化/発動率減少系"]
  ,[791, "魅了時弱化[ツァトグァ]/Charm Weakening[Tsathoggua]", "みりしし つ", TAG_TYPE.IRREMOVABLE_DEBUFF, "魅了時弱化/防御減少系"]
  ,[792, "注目時弱化/Taunt Weakening", "ちゆしし", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,[793, "注目時弱化[テスカトリポカ]/Taunt Weakening[Tezcatlipoca]", "ちゆしし て", TAG_TYPE.IRREMOVABLE_DEBUFF, "注目時弱化/発動率減少系"]
  ...
  ,[810, "滋養時弱化[リョウタ]/Nourishment Weakening[Ryota]", "しようしし り", TAG_TYPE.IRREMOVABLE_DEBUFF, "滋養時弱化/攻撃減少系"]
  ,[811, "熱情時強化[ノブハル]/Ardor Strengthening[Nobuharu]", "ねつしき の", TAG_TYPE.IRREMOVABLE_BUFF, "熱情時強化/攻撃増加系"]
  ,[812, "確率崩し", "かくりつくす", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ,[813, "集中時強化[ジャンバヴァン]/Concentration Strengthening[Jambavan]", "しゆうしき し", TAG_TYPE.IRREMOVABLE_BUFF, "集中時強化/防御増加系"]
  ,[814, "弱体無効時強化[イクトシ]/Nullify Debuff Strengthening[Ikutoshi]", "しやくたいむしき い", TAG_TYPE.IRREMOVABLE_BUFF, "弱体無効時強化/防御増加系"]
  ...
  ,[817, "烙印時弱化/Stigma Weakening", "らくしし", TAG_TYPE.IRREMOVABLE_BUFF, "防御減少系"]
  ,[818, "浄化時強化[サルタヒコ]/Purification Strengthening[Sarutahiko]", "しようかしき さ", TAG_TYPE.IRREMOVABLE_BUFF, "浄化時強化/CP増加系"]
  ,[819, "凍結時防御弱化/Freeze Weakened Defense", "とうけしほ", TAG_TYPE.IRREMOVABLE_DEBUFF, "被ダメージ追加系"]
  ,[820, "加速時強化[ゴウリョウ]/Acceleration Strengthening[Ganglie]", "かそしき こ", TAG_TYPE.IRREMOVABLE_BUFF, "加速時強化/攻撃増加系"]
  ,[821, "虚飾時弱化/Flamboyance Weakening", "きよしよしし", TAG_TYPE.IRREMOVABLE_DEBUFF, "防御減少系"]
  ,[822, "ダメージ時HP超激減/Enormously deplete HP when attacked", "ためしHPちよ", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ,[823, "非弱体時強化[スズカ]/Non-Debuff Strengthening[Suzuka]", "ひししき す", TAG_TYPE.IRREMOVABLE_BUFF, "非弱体時強化/攻撃増加系"]
  ...
  ,[826, "弱点時強化/Weakness Strengthening", "しやくてしき", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ,[827, "滋養時強化[ジブリール]/Nourishment Strengthening[Gabriel]", "しようしき し", TAG_TYPE.IRREMOVABLE_BUFF, "滋養時強化/CP増加系"]
  ,[828, "恐怖時弱化/Fear Weakening", "きようふしし", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,[829, "恐怖時弱化[シロウ]/Fear Weakening[Shiro]", "きようふしし し", TAG_TYPE.IRREMOVABLE_DEBUFF, "恐怖時弱化/防御減少系"]
  ...
  ,[843, "虚飾時強化/Flamboyance Strengthening", "きよしよしき", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ,[844, "攻撃力激減/ATK Vastly Down", "こうけきりよくけき", TAG_TYPE.IRREMOVABLE_DEBUFF, "攻撃減少系"]
  ,[845, "攻撃力激減[ボヘミオ]", "", TAG_TYPE.IRREMOVABLE_DEBUFF, "攻撃力激減/攻撃減少系"]
