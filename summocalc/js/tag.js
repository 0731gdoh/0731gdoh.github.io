...
Tag.createList = function(a){
  ...
  a.forEach(function(v, i){
    ...
    var name = v[0];
    if(link) link = link.indexOf(",") === -1 ? tget(link) : link.split(",").map(tget);
    if(v[6]){
      targetType = v[6][0];
      target = tget(v[6][1]);
      bonus = tget(v[6][2]);
...
var TAG = Tag.createList(
  ...
  ,[7, "防御力が上昇する状態/Status that raise defense", "ほう1", "", TAG_TYPE.STATUS_GROUP, "", "外壁/覚醒/頑強/金剛/守護/聖油/防御強化"]
  ...
  ,[18, "悪魔の契約/Demonic Pact", "あく", "与ダメx6.0\n被ダメx0.3\n$\n[@$]/Deal x6.0\nTake x0.3\n$\n[@$]/CP増加,契約の代償", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系/防御増加系/CP増加系"]
  ...
  ,[27, "*クルースニク/Kresnik", "く", "$1000\n[@$]/$ 1000\n[@$]/HP回復,祈り", TAG_TYPE.IRREMOVABLE_BUFF, "祈り時強化/HP回復系"]
  ,[28, "温泉/Hot Springs", "おん", "$/$/CP増加", TAG_TYPE.IRREMOVABLE_BUFF, "CP増加系"]
  ,[29, "回避/Evasion", "かいひ", "被ダメx0.01~0.005/Take 0.01~0.005x", TAG_TYPE.BUFF, "防御増加系"]
  ,[30, "*コタロウ/Kotaro", "こ", "発動率+80%\n[@$]/Skill Rate +80%\n[@$]/回避", TAG_TYPE.IRREMOVABLE_BUFF, "回避時強化/発動率増加系"]
  ...
  ,[58, "恐怖/Fear", "きようふ", "$\n移動不可/$\nCannot Move/CP減少", TAG_TYPE.DEBUFF, "CP減少系/移動封印系"]
  ...
  ,[74, "*クトゥグァ#1/Cthugha", "く1", "被ダメx0.35\n$\n[@$]/Take 0.35x\n$\n[@$]/CP増加,劫火", TAG_TYPE.IRREMOVABLE_BUFF, "劫火時強化/防御増加系/CP増加系"]
  ...
  ,[82, "告死/Countdown", "こく", "$10000~20000/$ 10000~20000/HP減少", TAG_TYPE.DEBUFF, "HP減少系"]
  ,[83, "金剛/Adamantine", "こんこ", "被ダメx0.9~0.45/Take 0.9~0.45x", TAG_TYPE.BUFF, "防御増加系"]
  ,[84, "*ヤスヨリ/Yasuyori", "や", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/金剛", TAG_TYPE.IRREMOVABLE_BUFF, "金剛時強化/攻撃増加系"]
  ,[85, "金剛に貫通/Ignore Adamantine", "かんこん", "2.22", TAG_TYPE.A_BONUS, "特攻/貫通"]
  ,[86, "根性/Guts", "こんし", "HP1で復活\n(発動時解除)/Revive with 1 HP\n(remove upon activation)", TAG_TYPE.BUFF, "復活系"]
  ,[87, "*浅草AR/Asakusa AR", "Aあ", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/根性", TAG_TYPE.IRREMOVABLE_BUFF, "根性時強化/攻撃増加系"]
  ,[88, "*マガン/Macan", "ま", "与ダメx2.0\n[@$]/Deal 2.0x\n[@$]/根性", TAG_TYPE.IRREMOVABLE_BUFF, "根性時強化/攻撃増加系"]
  ,[89, "再生/Regeneration", "さい", "$400~800/$ 400~800/HP回復", TAG_TYPE.BUFF, "HP回復系"]
  ...
  ,[94, "*マガン/Macan", "ま", "$400\n$\n[@$]/$ 400\n$\n[@$]/HP回復,CP増加,弱体(解除可)", TAG_TYPE.IRREMOVABLE_BUFF, "弱体時強化/HP回復系/CP増加系"]
  ,[95, "*ヴォルフ/Volkh", "う", "被ダメx0.1\n[@$]/Take 0.1x\n[@$]/弱体(解除可)", TAG_TYPE.IRREMOVABLE_BUFF, "弱体時強化/防御増加系"]
  ...
  ,[99, "弱体反射/Reflect Debuff", "しやくたいは", "$\n(発動時解除)/$\n(remove upon activation)/弱体反射", TAG_TYPE.BUFF, "弱体無効系"]
  ,[100, "弱体無効/Nullify Debuff", "しやくたいむ", "$\n(発動時解除)/$\n(remove upon activation)/弱体無効", TAG_TYPE.BUFF, "弱体無効系"]
  ...
  ,[106, "祝福/Blessing", "しゆく", "$300~600/$ 300~600/HP回復", TAG_TYPE.BUFF, "HP回復系"]
  ,[107, "*チョウジ/Choji", "ち", "与ダメx2.0\n[@$]/Deal 2.0x\n[@$]/祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/攻撃増加系"]
  ,[108, "*メフィストフェレス/Mephistopheles", "め", "$1200\n[@$]/$ 1200\n[@$]/HP減少,祝福", TAG_TYPE.IRREMOVABLE_DEBUFF, "祝福時弱化/HP減少系"]
  ...
  ,[126, "凍結/Freeze", "とうけ", "被ダメx1.1~2.2\n$200~400/Take 1.1~2.2x\n$ 200~400/HP減少", TAG_TYPE.DEBUFF, "防御減少系/HP減少系"]
  ,[127, "*イツァムナー/Itzamna", "い", "発動率-50%\n[@$]/Skill Rate -50%\n[@$]/凍結", TAG_TYPE.IRREMOVABLE_DEBUFF, "凍結時弱化/発動率減少系"]
  ,[128, "闘志/Vigor", "とうし", "与ダメx1.2~2.4/Deal 1.2~2.4x", TAG_TYPE.BUFF, "攻撃増加系"]
  ,[129, "毒/Poison", "とく", "$100~200/$ 100~200/HP減少", TAG_TYPE.DEBUFF, "HP減少系"]
  ,[130, "毒反転/Poison Reversal", "とくは", "与ダメx2.0\n被ダメx0.6\n$400\n[@$]/Deal 2.0x\nTake 0.6x\n$ 400[@$]/HP回復,毒", TAG_TYPE.BUFF, "攻撃増加系/防御増加系/HP回復系"]
  ...
  ,[184, "不動/Immobility", "ふと", "$\n移動不可/$\nCannot Move/CP増加", TAG_TYPE.BUFF, "CP増加系/移動封印系"]
  ,[185, "奮起/Arousal", "ふん", "$/$/CP増加", TAG_TYPE.BUFF, "CP増加系"]
  ...
  ,[217, "魔王と名の付くスキル/Load skills", "まお", "", TAG_TYPE.SKILL, "", "僥倖の魔王/混沌の魔王/大運動祭の魔王/退廃の魔王/第四天魔王の子/大力の魔王/常闇の魔王/墓場の魔王/魔王"]
  ...
  ,[255, "不死身なる者/Immortal", "ふしみなるも", "", TAG_TYPE.SKILL, "", "不死身の密林王/不死身なるジェミニ"]
  ...
  ,[301, "*カトブレパス/Catoblepas", "か", "被ダメx1.5\n[@$]/Take 1.5x\n[@$]/魅了", TAG_TYPE.IRREMOVABLE_DEBUFF, "魅了時弱化/防御減少系"]
  ,[302, "*カトブレパス/Catoblepas", "か", "発動率-50%\n[@$]/Skill Rate -50%\n[@$]/暗闇", TAG_TYPE.IRREMOVABLE_DEBUFF, "暗闇時弱化/発動率減少系"]
  ...
  ,[305, "HPが減少する弱体/HP reducing debuffs", "HPけん", "", TAG_TYPE.STATUS_GROUP, "", "告死/凍結/毒/トドメ/猛毒/火傷/烙印"]
  ...
  ,[311, "*ジュウゴ/Jugo", "し", "与ダメx6.0\n[@$]/Deal 6.0x\n[@$]/呪い", TAG_TYPE.IRREMOVABLE_BUFF, "呪い時強化/攻撃増加系"]
  ,[312, "烙印時強化/Stigma Strengthening", "らくしき", "被ダメx0.2\n[@$]/Take 0.2x\n[@$]/烙印", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ,[313, "*ジュウゴ/Jugo", "しゆ", "発動率+80%\n[@$]/Skill Rate +80%\n[@$]/告死", TAG_TYPE.IRREMOVABLE_BUFF, "告死時強化/発動率増加系"]
  ...
  ,[338, "全弱体特攻[アリス]", "", "", TAG_TYPE.IRREMOVABLE_BUFF, "全弱体特攻/特攻付与系/攻撃増加系", , [TAG_FLAG_NUM.BONUS_A, "すべての解除可能な弱体", "特攻[1.4]"]]
  ,[339, "継続回復強化/Continuous HP recovery boosted", "けいそくか", "状態変化のHP回復量x2.0/Restore HP by status effects 2.0x", TAG_TYPE.IRREMOVABLE_BUFF, "効果増強系"]
  ,[340, "*3.0", "3", "状態変化のHP減少量x3.0/Decrease HP by status effects 3.0x", TAG_TYPE.IRREMOVABLE_DEBUFF, "継続ダメージ強化/効果増強系"]
  ,[341, "強化を再付与/Reapply buff", "きようかをさ", "", TAG_TYPE.ONE_SHOT, "複製・貼付系"]
  ,[342, "弱体を再付与/Reapply debuff", "しやくたいをさ", "", TAG_TYPE.ONE_SHOT, "複製・貼付系"]
  ,[343, "*トウジ/Toji", "と", "与ダメx6.0\n[@$]/Deal 6.0x\n[@$]/呪い", TAG_TYPE.IRREMOVABLE_BUFF, "呪い時強化/攻撃増加系"]
  ,[344, "*限定アールプ/Limited Alp", "ああ3", "与ダメx1.5\n発動率+20%\n[@$ 1つにつき]/Deal 1.5x\nSkill Rate +20%\n[for each @$]/注目", TAG_TYPE.IRREMOVABLE_BUFF, "注目時強化/攻撃増加系/発動率増加系"]
  ...
  ,[353, "加速[重複可]/Acceleration[Stackable]", "かそs", "$\n[重複可x3]/$\n[Stackable 3x]/CP増加", TAG_TYPE.IRREMOVABLE_BUFF, "加速/CP増加系"]
  ...
  ,[369, "*タンガロア∞/Tangaroa∞", "た", "解除可能な各弱体の与ダメ・被ダメ・発動率を上書き/Overwrite Deal¡Take¡Skill Rate for each removable debuff", TAG_TYPE.IRREMOVABLE_BUFF, "弱体時強化/攻撃増加系/防御増加系/発動率増加系"]
  ,[370, "攻撃力強化解除/Remove all attack-rising status effects", "こうけきりよくき", "", TAG_TYPE.UNKNOWN, "状態耐性系/状態解除系"]
  ,[371, "*シンヤ/Shinya", "しん", "発動率-??%\n[@$]/Skill Rate -??%\n[@$]/魅了", TAG_TYPE.IRREMOVABLE_DEBUFF, "魅了時弱化/発動率減少系"]
  ...
  ,[394, "確率発狂/Latent Madness", "かくりつはつ", "確率で自身に$/Chance of $ on self/発狂", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ,[395, "*ニャルラトテプ☆4/Nyarlathotep ☆4", "に2", "被ダメx3.0\n[@$]/Take 3.0x\n[@$]/発狂", TAG_TYPE.IRREMOVABLE_DEBUFF, "発狂時弱化/防御減少系"]
  ...
  ,[420, "ロジックボム/Logic Bomb", "ろしつ", "", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ...
  ,[424, "*ヘカテー/Hecate", "へ", "$300\n[@$]/$ 300\n[@$]/HP回復,結縁：愛", TAG_TYPE.IRREMOVABLE_BUFF, "愛時強化/HP回復系"]
  ...
  ,[434, "被回復増加/Increased Recovery", "ひかい", "スキルやCSのHP回復量x1.5/Restore HP by skill and CS effects 1.5x", TAG_TYPE.BUFF, "効果増強系"]
  ...
  ,[438, "*タダトモ/Tadatomo", "た", "$1000\n[@$]/$ 1000\n[@$]/HP回復,火傷", TAG_TYPE.IRREMOVABLE_BUFF, "火傷時強化/HP回復系"]
  ,[439, "弱体無効時強化/Nullify Debuff Strengthening", "しやくたいむしき", "", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[440, "*ウランバートル☆3/Ulaanbaatar ☆3", "う3", "与ダメx3.0\n[@$]/Deal 3.0x\n[@$]/弱体無効", TAG_TYPE.IRREMOVABLE_BUFF, "弱体無効時強化/攻撃増加系"]
  ,[441, "*ウランバートル☆5/Ulaanbaatar ☆5", "う5", "与ダメx5.0\n[@$]/Deal 5.0x\n[@$]/弱体無効", TAG_TYPE.IRREMOVABLE_BUFF, "弱体無効時強化/攻撃増加系"]
  ...
  ,[459, "*アキハゴンゲン/Akiha Gongen", "あ", "$\n[@$]/$\n[@$]/CP増加,火傷", TAG_TYPE.IRREMOVABLE_BUFF, "火傷時強化/CP増加系"]
  ,[460, "*アキハゴンゲン/Akiha Gongen", "あき", "$600\n[@$]/$ 600\n[@$]/HP減少,魅了", TAG_TYPE.IRREMOVABLE_DEBUFF, "魅了時弱化/HP減少系"]
  ,[461, "縦移動力増加/Increased vertical movement", "たてそう", "$/$/移動力増加(縦)", TAG_TYPE.BUFF, "移動力増加系"]
  ,[462, "*カトブレパス/Catoblepas", "か", "与ダメ+1200\n[@$]/Deal +1200\n[@$]/意気", TAG_TYPE.IRREMOVABLE_BUFF, "意気時強化/与ダメージ追加系"]
  ...
  ,[470, "攻撃後強化単体奪取/Steal Buff Post-attack", "こうけきこきよ", "確率で敵から$/Chance of $ from target/強化奪取(単)", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃後]"]
  ,[471, "攻撃後弱点付与/Weakness Post-attack", "こうけきこしや", "確率で敵に$/Chance of $ on target/弱点", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃後]"]
  ,[472, "攻撃後CP吸収/Absorb CP Post-attack", "こうけきこCP", "敵から$/$ from target/CP吸収", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃後]"]
  ...
  ,[475, "*エリイ/Ellie", "え", "$500\n[@$]/$ 500\n[@$]/HP減少,暗闇", TAG_TYPE.IRREMOVABLE_DEBUFF, "暗闇時弱化/HP減少系"]
  ,[476, "ターン開始時憑依/Possession Start of Turn", "たあひよ", "(HPが50%以下の時)\n自身に$/(when HP is 50% or lower)\n$ on self/憑依", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ターン開始時]"]
  ,[477, "攻撃後HP吸収/Absorb HP Post-attack", "こうけきこHPき", "(HPが50%以上の時)\n敵から$/(when HP is 50% or higher)\n$ from target/HP吸収", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃後]"]
  ,[478, "攻撃時極限付与/Limit when attacking", "こうけきしきよ", "自身に$/$ on self/極限", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃時]"]
  ,[479, "空振り時CP減少/Decrease CP on miss", "からCP", "自身に$/$ of self/CP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "[空振り時]"]
  ,[480, "攻撃後HP回復/Restore HP post-attack", "こうけきこHPか", "自身に$/$ of self/HP回復", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃後]"]
  ,[481, "空振り時烙印付与/Stigma on miss", "かららく", "自身に$/$ on self/烙印", TAG_TYPE.IRREMOVABLE_DEBUFF, "[空振り時]"]
  ,[482, "強化後集中付与/Concentration Post-Buff", "きようかこし", "確率で隣接1マス内に$/Chance of $ on self and adjacent squares/集中", TAG_TYPE.IRREMOVABLE_BUFF, "[強化後]"]
  ...
  ,[493, "*バートロ/Bertro", "は", "被ダメx2.5\n[@$]/Take 2.5x\n[@$]/凍結", TAG_TYPE.IRREMOVABLE_DEBUFF, "凍結時弱化/防御減少系"]
  ,[494, "*バートロ/Bertro", "は", "与ダメx2.5\n被ダメx0.3\n[@$]/Deal 2.5x\nTake 0.3x\n[@$]/祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/攻撃増加系/防御増加系"]
  ,[495, "継続ダメージを受ける状態(解除可能)/Continuous damage status (removable)", "けいをう", "", TAG_TYPE.STATUS_GROUP, "", "告死/凍結/毒/トドメ/無窮/猛毒/火傷/烙印"]
  ,[496, "*シュクユウ/Zhurong", "しゆ", "被ダメx0.3\n[@$]/Take 0.3x\n[@$]/祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/防御増加系"]
  ...
  ,[501, "*イナバ/Inaba", "い", "$500\n[@$]/$ 500\n[@$]/HP回復,結縁：友", TAG_TYPE.IRREMOVABLE_BUFF, "友時強化/HP回復系"]
  ...
  ,[504, "確率束縛/Latent Bind", "かくりつそく", "確率で自身に$/Chance of $ on self/束縛", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ後]"]
  ,[505, "*ギリメカラ/Girimekra", "き", "被ダメx0.6\n[@$]/Take 0.6x\n[@$]/闘志", TAG_TYPE.IRREMOVABLE_BUFF, "闘志時強化/防御増加系"]
  ,[506, "*ギリメカラ/Girimekra", "き", "与ダメx0.75\n[@$]/Deal 0.75x\n[@$]/威圧", TAG_TYPE.IRREMOVABLE_DEBUFF, "威圧時弱化/攻撃減少系"]
  ...
  ,[509, "*ジェイコフ/Jacob", "しえ", "$1000\n[@$]/$ 1000\n[@$]/HP回復,暗闇", TAG_TYPE.IRREMOVABLE_BUFF, "暗闇時強化/HP回復系"]
  ...
  ,[553, "火傷大特攻[アフラ・マズダ]", "", "", TAG_TYPE.IRREMOVABLE_BUFF, "火傷大特攻/特攻付与系/攻撃増加系", , [TAG_FLAG_NUM.BONUS_A, "火傷", "特攻[2.0]"]]
  ...
  ,[558, "*キリト/Kirito", "き", "被ダメx3.0\n[@$]/Take 3.0x\n[@$]/幻惑", TAG_TYPE.IRREMOVABLE_DEBUFF, "幻惑時弱化/防御減少系"]
  ...
  ,[571, "巨人系スキル", "", "", TAG_TYPE.SKIP, "", "巨人なる者/巨人に戴かれる者/終わりの巨人/終焉のロプト/大運動祭の巨人王"]
  ...
  ,[586, "*ブギーマン/Boogeyman", "ふ", "与ダメx0.5\n[@$]/Deal 0.5x\n[@$]/告死", TAG_TYPE.IRREMOVABLE_DEBUFF, "告死時弱化/攻撃減少系"]
  ,[587, "幻惑時強化/Dazzle Strengthening", "けんしき", "与ダメx4.0\n[@$]/Deal 4.0x\n[@$]/幻惑", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ,[588, "攻撃時味方HP回復/Restore Ally's HP When Attacking", "こうけきしみかたHP", "右1マスに$/$ of 1 square right/HP回復", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃時]"]
  ,[589, "攻撃時味方CP増加/Increase Ally's CP When Attacking", "こうけきしみかたCP", "左1マスに$/$ of 1 square left/CP増加", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃時]"]
  ,[590, "閃き時強化/Glint Strengthening", "ひらしき", "", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[591, "*ヘカテー/Hecate", "へ", "被ダメx0.75\n[@$]/Take 0.75x\n[@$]/閃き", TAG_TYPE.IRREMOVABLE_BUFF, "閃き時強化/防御増加系"]
  ,[592, "*ヘカテー/Hecate", "へ", "", TAG_TYPE.IRREMOVABLE_BUFF, "退場時敵HP大回復/[退場時]"]
  ,[593, "*シパクトリ/Cipactli", "し", "被ダメx0.75\n[@$]/Take 0.75x\n[@$]/注目", TAG_TYPE.IRREMOVABLE_BUFF, "注目時強化/防御増加系"]
  ,[594, "激怒耐性/Rage Resistance", "けきたい", "", TAG_TYPE.IRREMOVABLE_BUFF, "状態耐性系", , [TAG_FLAG_NUM.NULLIFY, "激怒"]]
  ,[595, "*AR", "A", "与ダメx2.0\n[@$]/Deal 2.0x\n[@$]/祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/攻撃増加系"]
  ,[596, "*AR", "A", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/奮起", TAG_TYPE.IRREMOVABLE_BUFF, "奮起時強化/攻撃増加系"]
  ,[597, "*AR", "A", "発動率+5%\n[@$]/Skill Rate +5%\n[@$]/閃き", TAG_TYPE.IRREMOVABLE_BUFF, "閃き時強化/発動率増加系"]
  ,[598, "*アルジャーノン/Algernon", "ある", "与ダメx1.5\n[非@$]/Deal 1.5x\n[Not @$]/弱体(解除可)", TAG_TYPE.IRREMOVABLE_BUFF, "非弱体時強化/攻撃増加系"]
  ,[599, "攻撃力増加[オンブレティグレ]", "", "与ダメx1.2 → x3.0/Deal 1.2x → 3.0x", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃力増加/攻撃増加系"]
  ,[600, "*ヤマサチヒコ/Yamasachihiko", "や", "被ダメx0.7\n[@$]/Take 0.7x\n[@$]/根性", TAG_TYPE.IRREMOVABLE_BUFF, "根性時強化/防御増加系"]
  ,[601, "攻撃時回避/Evasion When Attacking", "こうけきしかい", "", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃時]"]
  ,[602, "ターン開始時CPに応じて攻防低下/ATK & DEF Down Based on CP at Turn Start", "たあCP", "", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ターン開始時]"]
  ,[603, "攻防低下/ATK & DEF Down", "こうほ", "与ダメx0.75 → x0.5\n被ダメx1.5 → x3.0/Deal 0.75x → 0.5x\nTake 1.5x → 3.0x", TAG_TYPE.IRREMOVABLE_DEBUFF, "攻撃減少系/防御減少系"]
  ,[604, "攻撃力増加[ベヒモス]", "", "与ダメx2.0 → x4.0/Deal 2.0x → 4.0x", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃力増加/攻撃増加系"]
  ,[605, "*アルスラーン/Arsalan", "あ", "$\n[@$]/$\n[@$]/CP増加,聖油", TAG_TYPE.IRREMOVABLE_BUFF, "聖油時強化/CP増加系"]
  ...
  ,[623, "*ハプニングAR/Chaos AR", "Aは", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/根性", TAG_TYPE.IRREMOVABLE_BUFF, "根性時強化/攻撃増加系"]
  ,[624, "*冥境AR/Caretaking AR", "Aめ", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/滋養", TAG_TYPE.IRREMOVABLE_BUFF, "滋養時強化/攻撃増加系"]
  ...
  ,[642, "*シトリー/Sitri", "しと", "発動率+10%\n[@$]/Skill Rate +10%\n[@$]/祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/発動率増加系"]
  ,[643, "*マサシ/Masashi", "ま", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/攻撃増加系"]
  ,[644, "強化後HP激減/Major HP Decrease When Buffed", "きようかこHPけき", "", TAG_TYPE.IRREMOVABLE_DEBUFF, "[強化後]"]
  ...
  ,[649, "*アマノジャク/Amanojaku", "あま", "$\n[非@$]/$\n[Not @$]/CP増加,弱体(解除可)", TAG_TYPE.IRREMOVABLE_BUFF, "非弱体時強化/CP増加系"]
  ...
  ,[658, "弱体後確率強化解除/Chance of buff removal post-debuff", "しやくたいこかくきよう", "確率で自身に$/Chance of $ from self/強化解除(単)", TAG_TYPE.IRREMOVABLE_DEBUFF, "[弱体後]"]
  ,[659, "*ペルーン/Perun", "へ", "被ダメx2.0\n[@$]/Take 2.0x\n[@$]/奮起", TAG_TYPE.IRREMOVABLE_DEBUFF, "奮起時弱化/防御減少系"]
  ,[660, "マヒ時弱化/Paralysis Weakening", "まひしし", "", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,[661, "*ペルーン/Perun", "へ", "被ダメx2.0\n[@$]/Take 2.0x\n[@$]/マヒ", TAG_TYPE.IRREMOVABLE_DEBUFF, "マヒ時弱化/防御減少系"]
  ...
  ,[667, "移動フェーズ終了後熱情付与/Bestow Ardor at end of movement phase", "いとうふえねつ", "", TAG_TYPE.IRREMOVABLE_BUFF, "[移動フェーズ終了後]"]
  ...
  ,[671, "*ウランバートル/Ulaanbaatar", "う", "被ダメx1.5\n[非@$]/Take 1.5x\n[Not @$]/強化(解除可)", TAG_TYPE.IRREMOVABLE_DEBUFF, "非強化時弱化/防御減少系"]
  ...
  ,[683, "*タイシャクテン/Taishakuten", "た", "与ダメx0.4\n[@$]/Deal 0.4x\n[@$]/威圧", TAG_TYPE.IRREMOVABLE_DEBUFF, "威圧時弱化/攻撃減少系"]
  ,[684, "*タイシャクテン/Taishakuten", "たい", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/注目", TAG_TYPE.IRREMOVABLE_BUFF, "注目時強化/攻撃増加系"]
  ,[685, "*クランプス/Krampus", "く", "被ダメx1.5\n[@$]/Take 1.5x\n[@$]/注目", TAG_TYPE.IRREMOVABLE_DEBUFF, "注目時弱化/防御減少系"]
  ...
  ,[697, "*ザオウ/Zao", "さ", "$\n[@$]/$\n[@$]/CP増加,根性", TAG_TYPE.IRREMOVABLE_BUFF, "根性時強化/CP増加系"]
  ,[698, "*クマノゴンゲン/Kumano Gongen", "く", "与ダメx2.0\n[@$]/Deal 2.0x\n[@$]/火傷", TAG_TYPE.IRREMOVABLE_BUFF, "火傷時強化/攻撃増加系"]
  ...
  ,[718, "移動後極限付与/Bestow Limit after movement", "いとうこきよく", "周囲1マス内に$/$ on self and 1 square in all directions/極限", TAG_TYPE.IRREMOVABLE_BUFF, "[移動後]"]
  ,[719, "毒時強化/Poison Strengthening", "とくしき", "", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[720, "*イグ/Yig", "い", "与ダメx3.0\n[@$]/Deal 3.0x\n[@$]/毒", TAG_TYPE.IRREMOVABLE_BUFF, "毒時強化/攻撃増加系"]
  ,[721, "アジテーション", "あし", "確率で距離2マス内に$\n(発動時解除)/Chance of $ on self and a diamond radius of 2 squares\n(remove upon activation)/疑念", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ,[722, "*バティム/Bathym", "は", "被ダメx2.0\n[@$]/Take 2.0x\n[@$]/魅了", TAG_TYPE.IRREMOVABLE_DEBUFF, "魅了時弱化/防御減少系"]
  ,[723, "マヒ大特攻/Big Advantage vs Paralysis", "まひたいと", "", TAG_TYPE.IRREMOVABLE_BUFF, "特攻付与系/攻撃増加系", , [TAG_FLAG_NUM.BONUS_A, "マヒ", "特攻[2.0]"]]
  ,[724, "移動フェーズ終了後奮起付与/Bestow Arousal when movement phase ends", "いとうふえふん", "左右1マスに$/$ on 1 square left and right/奮起", TAG_TYPE.IRREMOVABLE_BUFF, "[移動フェーズ終了後]"]
  ...
  ,[728, "*ハクメン/Hakumen", "は", "$\n[@$]/$\n[@$]/CP増加,暴走+", TAG_TYPE.IRREMOVABLE_BUFF, "暴走+時強化/CP増加系"]
  ,[729, "スキル発動率が減少する状態", "すきるは", "", TAG_TYPE.STATUS_GROUP, "", "脱力/妨害"]
  ,[730, "CSが封印される状態", "CS", "", TAG_TYPE.STATUS_GROUP, "", "CS封印/暗闇/二重封印"]
  ,[731, "*サトルヌス/Saturnus", "さと", "与ダメx2.0\n[@$]/Deal 2.0x\n[@$]/注目", TAG_TYPE.IRREMOVABLE_BUFF, "注目時強化/攻撃増加系"]
  ,[732, "ターン開始時防御貫通/Pierce Defense at Turn Start", "たあほう", "(HPが最大値の時)\n自身に$/(when HP is at max)\n$ on self/防御貫通", TAG_TYPE.IRREMOVABLE_BUFF, "[ターン開始時]"]
  ,[733, "照準/Sharpshooter", "しようしゆ", "自身に$\n\n被ダメx1.5~3.0/$ on self\n\nTake 1.5~3.0x/照準解除", TAG_TYPE.IRREMOVABLE_DEBUFF, "防御減少系/[ダメージ後]"]
  ,[734, "照準解除", "しようしゆか", "", TAG_TYPE.UNKNOWN, "状態耐性系/状態解除系"]
  ,[735, "*トムテ/Tomte", "と", "与ダメx2.0\n[@$]/Deal 2.0x\n[@$]/閃き", TAG_TYPE.IRREMOVABLE_BUFF, "閃き時強化/攻撃増加系"]
  ,[736, "対ダメージCP増加/Increase CP on Counter", "たいためCP", "敵に$/$ of enemy/CP増加", TAG_TYPE.IRREMOVABLE_DEBUFF, "[対ダメージ]"]
  ,[737, "*エーコー/Echo", "え", "被ダメx0.1\n[@$]/Take 0.1x\n[@$]/祈り", TAG_TYPE.IRREMOVABLE_BUFF, "祈り時強化/防御増加系"]
  ,[738, "退場時HP回復/Restore HP on Defeat", "たいしよHPか", "敵全体に$/$ of all enemies/HP回復", TAG_TYPE.IRREMOVABLE_DEBUFF, "[退場時]"]
  ,[739, "退場時CP増加/Increase CP on Defeat", "たいしよCPそ", "敵全体に$/$ of all enemies/CP増加", TAG_TYPE.IRREMOVABLE_DEBUFF, "[退場時]"]
  ...
  ,[745, "*ガルム#1/Garmr", "かる1", "与ダメx4.0\n[@$]/Deal 4.0x\n[@$]/加速", TAG_TYPE.IRREMOVABLE_BUFF, "加速時強化/攻撃増加系"]
  ,[746, "*ガルム#2/Garmr", "かる2", "被ダメx0.5\n[@$]/Take 0.5x\n[@$]/加速", TAG_TYPE.IRREMOVABLE_BUFF, "加速時強化/防御増加系"]
  ...
  ,[749, "*ニャルラトテプ/Nyarlathotep", "に", "与ダメx8.0\n[@$]/Deal 8.0x\n[@$]/発狂", TAG_TYPE.IRREMOVABLE_BUFF, "発狂時強化/攻撃増加系"]
  ...
  ,[752, "*限定ニャルラトテプ/Limited Nyarlathotep", "に3", "与ダメx0.5\n[@$]/Deal 0.5x\n[@$]/発狂", TAG_TYPE.IRREMOVABLE_DEBUFF, "発狂時弱化/攻撃減少系"]
  ...
  ,[759, "ロシアンルーレット/Russian Roulette", "ろしあ", "", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ...
  ,[769, "*ハーロット#1/Babalon", "は1", "$\n[@$]/$\n[@$]/CP増加,不動", TAG_TYPE.IRREMOVABLE_BUFF, "不動時強化/CP増加系"]
  ,[770, "*ハーロット#2/Babalon", "は2", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/不動", TAG_TYPE.IRREMOVABLE_BUFF, "不動時強化/攻撃増加系"]
  ,[771, "*プロメテウス/Prometheus", "ふ", "与ダメx1.5\n被ダメx0.7\n[@$]/Deal 1.5x\nTake 0.7x\n[@$]/火傷", TAG_TYPE.IRREMOVABLE_BUFF, "火傷時強化/攻撃増加系/防御増加系"]
  ,[772, "*ベルフェゴール/Belphegor", "へ", "$\n[@$]/$\n[@$]/CP増加,祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/CP増加系"]
  ,[773, "友時強化/Friendship Strengthening", "ゆうしき", "", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[774, "*ベルフェゴール/Belphegor", "へ", "$\n[@$]/$\n[@$]/CP増加,結縁：友", TAG_TYPE.IRREMOVABLE_BUFF, "友時強化/CP増加系"]
  ,[775, "暴走時強化/Berserk Strengthening", "ほうそしき", "", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[776, "*アメノウズメ/Ame-no-Uzume", "あ", "被ダメx0.3\n[@$]/Take 0.3x\n[@$]/暴走", TAG_TYPE.IRREMOVABLE_BUFF, "暴走時強化/防御増加系"]
  ,[777, "*アメノウズメ/Ame-no-Uzume", "あ", "被ダメx0.3\n[@$]/Take 0.3x\n[@$]/暴走+", TAG_TYPE.IRREMOVABLE_BUFF, "暴走+時強化/防御増加系"]
  ,[778, "ターン開始時HP回復/Restore HP at Turn Start", "たあHPか", "(3ターン毎)\n自身に$\n(30%)/(every 3 turns)\n$ of self\n(30%)/HP回復", TAG_TYPE.IRREMOVABLE_BUFF, "[ターン開始時]"]
  ...
  ,[810, "*リョウタ/Ryota", "り", "与ダメx0.6\n[@$]/Deal 0.6x\n[@$]/滋養", TAG_TYPE.IRREMOVABLE_DEBUFF, "滋養時弱化/攻撃減少系"]
  ,[811, "*ノブハル/Nobuharu", "の", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/熱情", TAG_TYPE.IRREMOVABLE_BUFF, "熱情時強化/攻撃増加系"]
  ,[812, "確率崩し", "かくりつくす", "確率で自身に$/Chance of $ on self/崩し", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ,[813, "*ジャンバヴァン/Jambavan", "し", "被ダメx0.7\n[@$]/Take 0.7x\n[@$]/集中", TAG_TYPE.IRREMOVABLE_BUFF, "集中時強化/防御増加系"]
  ,[814, "*イクトシ/Ikutoshi", "い", "被ダメx0.7\n[@$]/Take 0.7x\n[@$]/弱体無効", TAG_TYPE.IRREMOVABLE_BUFF, "弱体無効時強化/防御増加系"]
  ,[815, "ターン開始時極限/Limit at Turn Start", "たあきよく", "(HPが80%以下の時)\n自身に$/(when HP is 80% or lower)\n$ on self/極限", TAG_TYPE.IRREMOVABLE_BUFF, "[ターン開始時]"]
  ...
  ,[818, "*サルタヒコ/Sarutahiko", "さ", "$\n[@$]/$\n[@$]/CP増加,浄化", TAG_TYPE.IRREMOVABLE_BUFF, "浄化時強化/CP増加系"]
  ,[819, "凍結時防御弱化/Freeze Weakened Defense", "とうけしほ", "被ダメ+10000\n[@$]/Take +10000\n[@$]/凍結", TAG_TYPE.IRREMOVABLE_DEBUFF, "被ダメージ追加系"]
  ,[820, "*ゴウリョウ/Ganglie", "こ", "与ダメx6.0\n[@$]/Deal 6.0x\n[@$]/加速", TAG_TYPE.IRREMOVABLE_BUFF, "加速時強化/攻撃増加系"]
  ...
  ,[852, "凍結[重複可]/Freeze[Stackable]/凍結", "とうけs", "被ダメx1.1~2.2\n$200~400\n[重複可x4]/Take 1.1~2.2x\n$ 200~400\n[Stackable 4x]/HP減少", TAG_TYPE.DEBUFF, "凍結/防御減少系/HP減少系"]
  ,[853, "無窮[重複可]/Infinitude[Stackable]/無窮", "むきs", "与ダメx1.3~2.6\n$400~800\n[重複可x2]/Deal 1.3~2.6x\n$ 400~800\n[Stackable 2x]/HP減少", TAG_TYPE.BUFF, "無窮/攻撃増加系/HP減少系"]
  ,[854, "*テュアリング/Tuaring", "て", "$1000\n[@$]/$ 1000\n[@$]/HP減少,毒", TAG_TYPE.IRREMOVABLE_DEBUFF, "毒時弱化/HP減少系"]
  ,[855, "*クアンタム/Quantum", "く", "$10000\n[@$]/$ 10000\n[@$]/HP減少,毒", TAG_TYPE.IRREMOVABLE_DEBUFF, "毒時弱化/HP減少系"]
  ...
  ,[860, "空振り時HP減少", "からHPけん", "自身に$/$ of self/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "[空振り時]"]
  ,[861, "空振り時HP超激減", "からHPち", "自身に$/$ of self/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "[空振り時]"]
  ...
  ,[883, "*+4", "4", "$/$/移動力増加(全+4)", TAG_TYPE.IRREMOVABLE_BUFF, "全方向移動力大増/移動力増加系"]
  ,[884, "*+2", "2", "$/$/移動力増加(全+2)", TAG_TYPE.IRREMOVABLE_BUFF, "全方向移動力大増/移動力増加系"]
  ,[885, "告死時強化/Countdown Strengthening", "こくしき", "", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[886, "*シノ/Shino", "しの", "与ダメx6.0\n[@$]/Deal 6.0x\n[@$]/告死", TAG_TYPE.IRREMOVABLE_BUFF, "告死時強化/攻撃増加系"]
  ,[887, "*シノ/Shino", "しの", "発動率+10%\n[@$]/Skill Rate +10%\n[@$]/祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/発動率増加系"]
  ,[888, "妨害時弱化/Obstruct Weakening", "ほうかしし", "与ダメx0.5\n[@$]/Deal 0.5x\n[@$]/妨害", TAG_TYPE.IRREMOVABLE_DEBUFF, "攻撃減少系"]
  ,[889, "幻惑時弱化/Dazzle Weakening", "けんしし", "", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,[890, "*チェルノボーグ/Chernobog", "ち", "与ダメx0.7\n[@$]/Deal 0.7x\n[@$]/幻惑", TAG_TYPE.IRREMOVABLE_DEBUFF, "幻惑時弱化/攻撃減少系"]
  ,[891, "祝福特攻/Advantage vs Blessing", "しゆくと", "", TAG_TYPE.IRREMOVABLE_BUFF, "特攻付与系/攻撃増加系", , [TAG_FLAG_NUM.BONUS_A, "祝福", "特攻[1.5]"]]
  ,[892, "*カルブンクロ/Carbuncle", "か", "$\n[@$]/$\n[@$]/CP増加,祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/CP増加系"]
  ,[893, "大運動祭の魔王", "たいうま", "", TAG_TYPE.SKILL]
  ,[894, "大運動祭の巨人王", "たいうき", "", TAG_TYPE.SKILL]
  ...
  ,[906, "トドメ", "とと", "$250~500\nHP0で退場/$ 250~500\nDefeat at 0 HP/HP減少", TAG_TYPE.DEBUFF, "HP減少系"]
  ,[907, "*500", "1", "自身に$\n(500)/$ of self\n(500)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "弱体後HP減少/[弱体後]"]
  ,[908, "*1000", "3", "自身に$\n(1000)/$ of self\n(1000)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "弱体後HP減少/[弱体後]"]
  ,[909, "*5%", "4", "自身に$\n(5%)/$ of self\n(5%)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "弱体後HP減少/[弱体後]"]
  ,[910, "*10%", "5", "自身に$\n(10%)/$ of self\n(10%)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "弱体後HP減少/[弱体後]"]
  ,[911, "*オスカー/Oscar", "お", "与ダメx2.0\n[@$]/Deal 2.0x\n[@$]/劫火", TAG_TYPE.IRREMOVABLE_BUFF, "劫火時強化/攻撃増加系"]
  ,[912, "火傷大特攻/Big Advantage vs Burn", "やけたいと", "", TAG_TYPE.IRREMOVABLE_BUFF, "特攻付与系/攻撃増加系"]
  ,[913, "火傷大特攻[ユーマ]", "", "", TAG_TYPE.IRREMOVABLE_BUFF, "火傷大特攻/特攻付与系/攻撃増加系", , [TAG_FLAG_NUM.BONUS_A, "火傷", "特攻[2.0]"]]
  ,[914, "*ユーマ：自身/Yuma: self", "ゆ1", "与ダメx2.0\n[@$]/Deal 2.0x\n[@$]/閃き", TAG_TYPE.IRREMOVABLE_BUFF, "閃き時強化/攻撃増加系"]
  ,[915, "*ユーマ：味方全体/Yuma: all allies", "ゆ2", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/閃き", TAG_TYPE.IRREMOVABLE_BUFF, "閃き時強化/攻撃増加系"]
  ,[916, "頑強時回復", "かんしか", "$500\n[@$]/$ 500\n[@$]/HP回復,頑強", TAG_TYPE.IRREMOVABLE_BUFF, "HP回復系"]
  ,[917, "猛毒[重複可]/Fatal Poison[Stackable]", "もうs", "$200~400\n[重複可x5]/$ 200~400\n[Stackable 5x]/HP減少", TAG_TYPE.DEBUFF, "猛毒/HP減少系"]
  ,[918, "弱体を再付与(単)/Reapply debuff (single)", "しやくたいをさ1", "", TAG_TYPE.ONE_SHOT, "弱体を再付与/複製・貼付系"]
  ,[919, "弱体を再付与(全)/Reapply debuff (all)", "しやくたいをさ3", "", TAG_TYPE.ONE_SHOT, "弱体を再付与/複製・貼付系"]
  ,[920, "強化を再付与(全)/Reapply buff", "きようかをさ3", "", TAG_TYPE.ONE_SHOT, "強化を再付与/複製・貼付系"]
  ,[921, "退場時敵HP大回復", "たいしよてきHP", "", TAG_TYPE.IRREMOVABLE_BUFF, "[退場時]"]
  ,[922, "*クルースニク/Kresnik", "く", "前3マスの敵に$\n(1500)/$ of enemies 3 squares forward\n(1500)/HP回復", TAG_TYPE.IRREMOVABLE_BUFF, "退場時敵HP大回復/[退場時]"]
  ,[923, "*800", "1", "自身に$\n(800)/$ of self\n(800)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "強化後HP減少/強化後HP減少[弱体]/[強化後]"]
  ,[924, "*800", "2", "自身に$\n(800)/$ of self\n(800)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "弱体後HP減少/[弱体後]"]
  ,[925, "*ツクヨミ/Tsukuyomi", "つ", "十字2マス内に$\n(500)/$ of self and in a cross radius of 2 squares\n(500)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "弱体後HP減少/[弱体後]"]
  ,[926, "攻撃後HP減少", "こうけきこHPけ", "自身に$\n(1000)/$ of self\n(1000)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "[攻撃後]"]
  ...
  ,[935, "虚飾大特攻/Big Advantage vs Flamboyance", "きよしよた", "", TAG_TYPE.IRREMOVABLE_BUFF, "特攻付与系/攻撃増加系", , [TAG_FLAG_NUM.BONUS_A, "虚飾", "特攻[2.0]"]]
  ,[936, "移動不能大特攻", "いとうふの", "", TAG_TYPE.IRREMOVABLE_BUFF, "特攻付与系/攻撃増加系", , [TAG_FLAG_NUM.BONUS_A, "移動不能になる状態", "特攻[2.0]"]]
  ,[937, "対ダメージ敵にHP減少", "たいためてきに", "敵に$\n(10%)/$ of enemy\n(10%)/HP減少", TAG_TYPE.IRREMOVABLE_BUFF, "[対ダメージ]"]
  ,[938, "移動後熱情付与", "いとうこねつ", "周囲1マスに$/$ on 1 square in all directions/熱情", TAG_TYPE.IRREMOVABLE_BUFF, "[移動後]"]
  ,[939, "移動後HP回復", "いとうこHP", "", TAG_TYPE.IRREMOVABLE_BUFF, "[移動後]"]
  ,[940, "*☆3", "3", "隣接1マスに$\n(300)/$ of adjacent squares\n(300)/HP回復", TAG_TYPE.IRREMOVABLE_BUFF, "移動後HP回復/[移動後]"]
  ,[941, "*☆5", "5", "周囲1マスに$\n(15%)/$ of 1 square in all directions\n(15%)/HP回復", TAG_TYPE.IRREMOVABLE_BUFF, "移動後HP回復/[移動後]"]
  ,[942, "発狂時強化/Madness Strengthening", "はつしき", "", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[943, "*アイギパーン/Aegipan", "あ", "与ダメx5.0\n[@$]/Deal 5.0x\n[@$]/発狂", TAG_TYPE.IRREMOVABLE_BUFF, "発狂時強化/攻撃増加系"]
  ,[944, "*アイギパーン/Aegipan", "あ", "$3000\n[@$]/$ 3000\n[@$]/HP減少,発狂", TAG_TYPE.IRREMOVABLE_DEBUFF, "発狂時弱化/HP減少系"]
  ...
  ,[952, "魅了特攻/Advantage vs Charm", "みりと", "", TAG_TYPE.IRREMOVABLE_BUFF, "特攻付与系/攻撃増加系", , [TAG_FLAG_NUM.BONUS_A, "魅了", "特攻[1.5]"]]
  ,[953, "奮起時強化/Arousal Strengthening", "ふんしき", "", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[954, "*クランプス/Krampus", "く", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/奮起", TAG_TYPE.IRREMOVABLE_BUFF, "奮起時強化/攻撃増加系"]
  ,[955, "*マルドゥック/Marduk", "ま", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/奮起", TAG_TYPE.IRREMOVABLE_BUFF, "奮起時強化/攻撃増加系"]
  ,[956, "*タローマティ/Taromaiti", "た", "与ダメx1.5\n[@$]/Deal 1.5x\n[@$]/奮起", TAG_TYPE.IRREMOVABLE_BUFF, "奮起時強化/攻撃増加系"]
  ,[957, "奮起時弱化/Arousal Weakening", "ふんしし", "", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ...
  ,[964, "*ガンダルヴァ#1/Gandharva", "か1", "$\n[@$]/$\n[@$]/CP増加,暴走", TAG_TYPE.IRREMOVABLE_BUFF, "暴走時強化/CP増加系"]
  ,[965, "*ガンダルヴァ#1/Gandharva", "か1", "$\n[@$]/$\n[@$]/CP増加,暴走+", TAG_TYPE.IRREMOVABLE_BUFF, "暴走+時強化/CP増加系"]
  ,[966, "*ガンダルヴァ#2/Gandharva", "か2", "被ダメx0.3\n[@$]/Take 0.3x\n[@$]/暴走", TAG_TYPE.IRREMOVABLE_BUFF, "暴走時強化/防御増加系"]
  ,[967, "*ガンダルヴァ#2/Gandharva", "か2", "被ダメx0.3\n[@$]/Take 0.3x\n[@$]/暴走+", TAG_TYPE.IRREMOVABLE_BUFF, "暴走+時強化/防御増加系"]
  ,[968, "*5.0", "5", "状態変化のHP減少量x5.0/Decrease HP by status effects 5.0x", TAG_TYPE.DEBUFF, "継続ダメージ強化/効果増強系"]
  ,[969, "退場時弱体全転写", "たいしよしや", "周囲1マスに$/$ to 1 square in all directions/弱体転写(全)", TAG_TYPE.DEBUFF, "[退場時]"]
  ,[970, "*マカラ#1/Makara", "ま1", "前3マスの敵に$\n(10%)/$ of enemies 3 squares forward\n(10%)/HP減少", TAG_TYPE.IRREMOVABLE_BUFF, "強化後HP減少/強化後HP減少[強化]/[強化後]"]
  ,[971, "*マカラ#2/Makara", "ま2", "前3列の敵に$\n(10%)/$ of enemies in forward row of 3\n(10%)/HP減少", TAG_TYPE.IRREMOVABLE_BUFF, "強化後HP減少/強化後HP減少[強化]/[強化後]"]
  ,[972, "不死身なるジェミニ", "ふしみなるし", "", TAG_TYPE.SKILL]
  ...
  ,[1035, "*ジャンバヴァン/Jambavan", "しや", "発動率+30%\n[@$]/Skill Rate +30%\n[@$]/祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/発動率増加系"]
  ,[1036, "回避時強化/Evasion Strengthening", "かいひしき", "", TAG_TYPE.IRREMOVABLE_BUFF]
  ,[1037, "*マクロイヒ/MacRoich", "ま", "与ダメx5.0\n[@$]/Deal 5.0x\n[@$]/回避", TAG_TYPE.IRREMOVABLE_BUFF, "回避時強化/攻撃増加系"]
  ,[1038, "*☆5+", "5+", "確率で味方全体に$&$&$\n(発動時解除)/Chance of $, $, and $ on all allies\n(remove upon activation)/HP減少,崩し,強化解除(単)", TAG_TYPE.IRREMOVABLE_DEBUFF, "ロジックボム/[ダメージ時]"]
]);
