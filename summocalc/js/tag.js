...
var TAG = Tag.createList(
  ...
  ,["ダメージ反転", "ためはん", TAG_TYPE.BUFF, "HP回復系"]
  ...
  ,["次ターン強化", "つき", TAG_TYPE.IRREMOVABLE_BUFF]
  ,["攻撃力増加[2.0]", "", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃力増加/攻撃増加系"]
  ,["攻撃力増加[1.6]", "", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃力増加/攻撃増加系"]
  ,["攻撃力増加[1.5]", "", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃力増加/攻撃増加系"]
  ,["攻撃力増加[1.4]", "", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃力増加/攻撃増加系"]
  ,["攻撃力増加[1.3]", "", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃力増加/攻撃増加系"]
  ,["攻撃力増加[1.2]", "", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃力増加/攻撃増加系"]
  ,["攻撃力増加", "こうけきりよくそ", TAG_TYPE.IRREMOVABLE_BUFF]
  ,["スキル発動率増加", "すきるはそ", TAG_TYPE.BUFF, "発動率増加系"]
]);
