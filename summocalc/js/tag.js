...
var TAG = Tag.createList(
  ...
  ,[394, "確率発狂/Latent Madness", "かくりつはつ", "確率で自身に$/Chanse of $ on self/発狂", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ...
  ,[504, "確率束縛/Latent Bind", "かくりつそく", "確率で自身に$/Chanse of $ on self/束縛", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ後]"]
  ...
  ,[514, "確率マヒ/Latent Paralysis", "かくりつまひ", "確率で敵に$/Chanse of $ on target/マヒ", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃時]"]
  ,[515, "魅了時強化/Charm Strengthening", "みりしき", "被ダメx0.3\n[@$]/Take 0.3x\n[@$]/魅了", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ,[516, "確率強化解除/Latent Buff Removal", "かくりつきようかか", "確率で自身に$/Chanse of $ from self/強化解除(単)", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ...
  ,[520, "確率強化単体解除/Latent Remove one buff", "かくりつきようかた", "確率で隣接1マス内に$/Chanse of $ from self and adjacent squares/強化解除(単)", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ,[521, "継続ダメージの発生する状態/Status that inflict Continuous Damage", "けいのは", "", TAG_TYPE.STATUS_GROUP, "", "告死/凍結/毒/トドメ/無窮/猛毒/火傷/烙印"]
  ,[522, "確率弱体単体解除/Latent Remove one debuff", "かくりつしや", "確率で自身に$/Chanse of $ from self/弱体解除(単)", TAG_TYPE.IRREMOVABLE_BUFF, "[弱体後]"]
  ...
  ,[812, "確率崩し", "かくりつくす", "確率で自身に$/Chanse of $ on self/崩し", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ時]"]
  ...
  ,[908, "弱体後HP減少[1000]/HP reduction post-debuff[1000]", "しやくたいこHPけん 2", "自身に$\n(1000)/$ on self\n(1000)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "弱体後HP減少/[弱体後]"]
  ,[909, "弱体後HP減少[5%]/HP reduction post-debuff[5%]", "しやくたいこHPけん 3", "自身に$\n(5%)/$ on self\n(5%)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "弱体後HP減少/[弱体後]"]
  ,[910, "弱体後HP減少[10%]/HP reduction post-debuff[10%]", "しやくたいこHPけん 4", "自身に$\n(10%)/$ on self\n(10%)/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "弱体後HP減少/[弱体後]"]
