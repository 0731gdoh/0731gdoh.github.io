...
var TAG = Tag.createList(
  ...
  ,[464, "退場時HP激減/Major HP decrease on Defeat", "たいしよHPけ", "距離2マスに$/$ on a diamond radius of 2 squares/HP減少", TAG_TYPE.IRREMOVABLE_BUFF, "[退場時]"]
  ,[465, "退場時CP激減/Major CP decrease on Defeat", "たいしよCPけ", "距離2マスに$/$ on a diamond radius of 2 squares/CP減少", TAG_TYPE.IRREMOVABLE_BUFF, "[退場時]"]
  ...
  ,[479, "空振り時CP減少/Decrease CP on miss", "からCP", "自身に$/$ on self/CP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "[空振り時]"]
  ,[480, "攻撃後HP回復/Restore HP post-attack", "こうけきこHPか", "自身に$/$ on self/HP回復", TAG_TYPE.IRREMOVABLE_BUFF, "[攻撃後]"]
  ...
  ,[892, "祝福時強化[カルブンクロ]/Blessing Strengthening[Carbuncle]", "しゆくしき か", "CP増加\n[@$]/Increase CP\n[@$]/祝福", TAG_TYPE.IRREMOVABLE_BUFF, "祝福時強化/CP増加系"]
  ...
  ,[899, "ダメージ後HP激減", "ためこHPけき", "自身に$/$ on self/HP減少", TAG_TYPE.IRREMOVABLE_DEBUFF, "[ダメージ後]"]
  ...
  ,[906, "トドメ", "とと", "HP減少250~500\nHP0で退場/Decrease HP 250~500\nDefeat at 0 HP", TAG_TYPE.DEBUFF, "HP減少系"]
  ...
  ,[916, "頑強時回復", "かんしか", "HP回復500\n[@$]/Restore HP 500\n[@$]/頑強", TAG_TYPE.IRREMOVABLE_BUFF, "HP回復系"]
  ,[917, "猛毒[重複可]/Fatal Poison[Stackable]", "もうs", "HP減少200~400\n[重複可x5]/Decrease HP 200~400\n[Stackable 5x]", TAG_TYPE.DEBUFF, "猛毒/HP減少系"]
