...
var TAG = Tag.createList(
  ...
  ,["頑強時強化/Tenacity Strengthening", "かんしき", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ...
  ,["劫火時強化/Conflagration Strengthening", "こうかしき", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系/CP増加系"]
  ...
  ,["非弱体時強化/Non-Debuff Strengthening", "ひししき", TAG_TYPE.IRREMOVABLE_BUFF, "発動率増加系"]
  ...
  ,["憑依時強化/Possession Strengthening", "ひよしき", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ...
  ,["大筒の支配者/Munitions Ruler", "おお", TAG_TYPE.SKILL]
  ...
  ,["轟き奔る者/Roaring Runner", "ととろき", TAG_TYPE.SKILL]
  ...
  ,["対ダメージ敵HPCP超激減/Counter: Massive HP%%CP reduction", "たいためてき", TAG_TYPE.IRREMOVABLE_BUFF]
  ...
  ,["HP減少反転/HP Decrease Reversal", "HPけはん", TAG_TYPE.BUFF, "HP回復系"]
  ,["HP回復反転/HP Recovery Reversal", "HPかはん", TAG_TYPE.DEBUFF, "HP減少系"]
  ,["ダメージ反転/Damage Reversal", "ためはん", TAG_TYPE.BUFF, "防御増加系"]
  ,["防御貫通/Pierce Defense", "ほうきよか", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ,["恐怖大特攻/Big Advantage vs Fear", "きようふた", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "恐怖"]
  ...
  ,["継続ダメージを受ける状態", "けい", TAG_TYPE.STATUS_GROUP, "", "告死/凍結/毒/無窮/猛毒/火傷/烙印"]
  ...
  ,["確率マヒ/Latent Paralysis", "かくりつまひ", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,["魅了時強化/Charm Strengthening", "みりしき", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ,["確率強化解除/Latent Remove Buff", "かくりつきよ", TAG_TYPE.IRREMOVABLE_DEBUFF]
