...
var TAG = Tag.createList(
  ...
  ,["攻撃力減少/Reduce Outgoing Damage", "こうけきりよくけ", TAG_TYPE.IRREMOVABLE_DEBUFF, "攻撃減少系"]
  ...
  ,["射撃弱点/Shot Weakness", "しやけし", TAG_TYPE.IRREMOVABLE_DEBUFF, "武器種弱点系/防御減少系"]
  ...
  ,["全弱体特攻/Advantage vs all debuffs", "せんし", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "全ての弱体"]
  ...
  ,["防御貫通/Pierce Defense", "ほうきよか", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ,["恐怖大特攻/Big Advantage vs Fear", "きようふたいと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "恐怖"]
  ,["打撃と斬撃と横一文字への大特防/Big Blow%%Slash%%Long-Slash damage reduction", "たけきとさ", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ,["射撃と狙撃への大特防/Big Shot%%Snipe damage reduction", "しやけと", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ,["特防[0.1]/D.Bonus[0.1]", "とくほ01", TAG_TYPE.D_BONUS, "特防"]
  ,["崩し耐性/Break Resistance", "くすたい", TAG_TYPE.BUFF, "状態耐性系"]
  ,["威圧特攻[AR]", "", TAG_TYPE.IRREMOVABLE_BUFF, "威圧特攻/攻撃増加系", , "威圧"]
  ,["閃き時強化/Glint Strengthening", "ひらしき", TAG_TYPE.IRREMOVABLE_BUFF, "発動率増加系"]
  ,["退場時強化全転写/Transfer all buffs on Defeat", "たいしよきよ", TAG_TYPE.IRREMOVABLE_BUFF]
  ,["退場時敵強化全解除/Remove all buffs on Defeat", "たいしよてき", TAG_TYPE.IRREMOVABLE_BUFF]
  ...
  ,["告死時弱化/Countdown Weakening", "こくしし", TAG_TYPE.IRREMOVABLE_DEBUFF, "発動率減少系"]
  ...
  ,["全域大特防/Big All damage reduction", "せんいた", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ...
  ,["弱点特攻/Advantage vs Weakness", "しやくてと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "弱点"]
  ,["係留時強化/Anchor Strengthening", "けいりしき", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ,["弱点耐性/Weakness Resistance", "しやくてたい", TAG_TYPE.BUFF, "状態耐性系"]
  ,["防御強化時回復/Heal on DEF Up", "ほうきよきしか", TAG_TYPE.IRREMOVABLE_BUFF, "HP回復系"]
  ,["強化後回復付与/HP Recovery on Buff", "きようかこか", TAG_TYPE.IRREMOVABLE_BUFF]
  ,["マシンボディ特攻", "ましんと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "マシン系スキル"]
  ...
  ,["回避貫通/Ignore Evasion[Buff]", "かいひか", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ...
  ,["攻撃時極限付与", "こうけきしきよ", TAG_TYPE.IRREMOVABLE_BUFF]
  ,["空振り時CP減少", "からCP", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ...
  ,["厄災の連鎖", "やく", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,["崩し特攻/Advantage vs Break", "くすしと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "崩し"]
  ,["全域特防[ビッグフット]", "", TAG_TYPE.IRREMOVABLE_BUFF, "全域特防/防御増加系"]
  ...
  ,["威圧特攻[ギリメカラ]", "", TAG_TYPE.IRREMOVABLE_BUFF, "威圧特攻/攻撃増加系", , "威圧"]
  ...
  ,["特防[0.65]/D.Bonus[0.65]", "とくほ065", TAG_TYPE.D_BONUS, "特防"]
  ,["武器種弱点系/Weapon Type Weakness", "ふき", TAG_TYPE.CATEGORY]
  ,["魔法弱点/Shot Weakness", "まほし", TAG_TYPE.IRREMOVABLE_DEBUFF, "武器種弱点系/防御減少系"]
  ,["確率マヒ", "かくりつまひ", TAG_TYPE.IRREMOVABLE_BUFF]
  ,["魅了時強化/Charm Strengthening", "みりしき", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
  ,["確率強化解除/Latent Remove Buff", "かくりつきようかか", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,["ダメージ時HP激減", "ためしHP", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ...
  ,["確率強化単体解除", "かくりつきようかた", TAG_TYPE.IRREMOVABLE_DEBUFF]
  ,["継続ダメージの発生する状態", "けいのは", TAG_TYPE.STATUS_GROUP, "", "告死/凍結/毒/無窮/猛毒/火傷/烙印"]
  ,["確率弱体単体解除", "かくりつしや", TAG_TYPE.IRREMOVABLE_BUFF]
  ...
  ,["注目時回復/Heal on Taunt", "ちゆしか", TAG_TYPE.IRREMOVABLE_BUFF, "HP回復系"]
  ...
  ,["幻惑耐性/Dazzle Resistance", "けんたい", TAG_TYPE.BUFF, "状態耐性系"]
  ,["猛毒時強化/Fatal Poison Strengthening", "もうしき", TAG_TYPE.IRREMOVABLE_BUFF]
  ...
  ,["集中時強化/Concentration Strengthening", "しゆうしき", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系"]
  ,["妨害時強化/Obstruct Strengthening", "ほうかしき", TAG_TYPE.IRREMOVABLE_BUFF, "発動率増加系"]
  ,["魅了耐性[解除不可]", "", TAG_TYPE.IRREMOVABLE_BUFF, "魅了耐性/状態耐性系"]
  ,["火傷特攻/Advantage vs Burn", "やけと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "火傷"]
  ,["火傷大特攻/Big Advantage vs Burn", "やけたいと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "火傷"]
  ,["劫火大特攻/Big Advantage vs Conflagration", "こうかたいと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "劫火"]
  ,["幻惑特攻/Advantage vs Dazzle", "けんと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "幻惑"]
  ,["烙印特攻/Advantage vs Stigma", "らくと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "烙印"]
  ,["妨害特攻/Advantage vs Obstruct", "ほうかと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "妨害"]
  ,["幻惑時弱化/Dazzle Weakening", "けんしし", TAG_TYPE.IRREMOVABLE_DEBUFF, "防御減少系"]
  ,["全域特防/All damage reduction", "せんいと", TAG_TYPE.IRREMOVABLE_BUFF]
  ,["魅了大特攻/Big Advantage vs Charm", "みりたいと", TAG_TYPE.IRREMOVABLE_BUFF, "攻撃増加系", , "魅了"]
  ...
  ,["打撃特防/Blow damage reduction", "たけきとく", TAG_TYPE.IRREMOVABLE_BUFF, "防御増加系"]
